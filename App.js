...
import {Platform, StyleSheet, View, Text,Image, TextInput, ScrollView, TouchableOpacity} from 'react-native';
      ...
      <ScrollView style={{flex: 1,backgroundColor: 'white'}}>
        ...
        <View style={{marginHorizontal: 17, flexDirection: 'row', paddingTop: 15}}>
          <View style={{position:'relative',flex: 1}}>  
            <TextInput placeholder="Mau Cari apa Di GO-JEK" style={{borderWidth: 1, borderColor: '#E8E8E8', borderRadius: 25, height: 40, fontSize: 13, paddingLeft: 45, paddingRight: 20, backgroundColor: 'white', marginRight: 18 }} />            
        ...
        <View style={{marginHorizontal: 17, marginTop: 8}}>
          ...
          <View style={{flexDirection: 'row', flexWrap: 'wrap', marginHorizontal: 0, marginTop: 18,}}>
            ...
            <View style={{width: '25%', alignItems: 'center'}}>
                <View style={{width: 58, height: 58, borderWidth: 1, borderColor: '#EFEFEF', borderRadius: 18, borderRadius: 18, justifyContent: 'center', alignItems: 'center'}}>
